$(function () {
    ...
    chat.client.addNewMessageToPage = function (name, message) {
        ...
        if (name === 'system') {
            ...
            var chattingMsg = '<a style="color: black">浙江工商大学的' + htmlEncode(name) + '</a>' + '<img src="https://www.qqmgs.com/img/photo/_female.jpg" style="max-height: 20px; margin-left: 5px;"> ' +
            ': <a style="margin-left: 5px; background-color: white; color: black; padding: 9px 13px;border-radius:5px;line-height: 1.6rem;">' + htmlEncode(message) + '</a>';
