...
namespace Twitter.App
{
    ...
    public class EmailService : IIdentityMessageService
    {
        ...
        private static Task ConfigMailSendAsync(IdentityMessage message)
        {
            ...
            var msg = new MailMessage { From = new MailAddress(mailAccount) };
            msg.To.Add(new MailAddress(message.Destination));
            msg.Subject = message.Subject;
            //msg.AlternateViews.Add(AlternateView.CreateAlternateViewFromString(text, null, MediaTypeNames.Text.Plain));
            msg.AlternateViews.Add(AlternateView.CreateAlternateViewFromString(html, null, MediaTypeNames.Text.Html));

            var smtpClient = new SmtpClient(ConfigurationManager.AppSettings["NeteaseSMTPServer"], Convert.ToInt32(25))
            {
